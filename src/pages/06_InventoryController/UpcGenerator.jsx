...
const UpcGenerator = () => {
  ...
  return (
    <DashboardLayout menuItems={menuItems} pageTitle="UPC Generator">
      <div className="max-w-7xl mx-auto">
        <Card className="p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">UPC Generator</h1>
          <p className="text-gray-600">Generate barcodes and UPC codes for your salon products.</p>
          
          {/* Content will be added here */}
          <div className="mt-8 p-8 border-2 border-dashed border-gray-300 rounded-lg text-center">
            <QrCode className="h-12 w-12 text-gray-400 mx-auto mb-4" />
            <p className="text-gray-500">UPC generator functionality coming soon...</p>
          </div>
        </Card>
      </div>
    </DashboardLayout>
